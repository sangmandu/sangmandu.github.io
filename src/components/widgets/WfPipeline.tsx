...
const t = {
  ko: {
    ...
    lines: [
      ...
      'name: wf',
      'description: |',
      '  사용자가 기능 개발, 버그 수정 등 개발',
      '  작업을 요청하면 이 스킬을 실행한다.',
      '---',
      '',
      '# WF — 개발 워크플로우',
      '',
      '이 스킬이 호출되면 아래 워크플로우를',
      '순서대로 진행하세요.',
      '',
      '## 1. 티켓',
  ...
  en: {
    ...
    lines: [
      ...
      'name: wf',
      'description: |',
      '  When the user requests dev work like',
      '  feature dev or bug fix, run this skill.',
      '---',
      '',
      '# WF — Dev Workflow',
      '',
      'When this skill is invoked, follow the',
